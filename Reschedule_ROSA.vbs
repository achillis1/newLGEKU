VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} Reschedule_ROSA 
   Caption         =   "Reschedule_ROSA"
   ClientHeight    =   7995
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   15465
   OleObjectBlob   =   "Reschedule_ROSA.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "Reschedule_ROSA"
...
For x = 11 To wsDblr
    If wsDb.Cells(x, NexantEnrollments.Enrollment_ID_ROSA) = EID Then
        ...
        If Me.Schedule_Date_ROSA = "" Then
            ...
            wsDb.Cells(x, NexantEnrollments.SCHEDULED_date_set_ROSA) = ""
...
Private Sub UserForm_Activate()
    ...
    For x = 11 To wsDblr
        If wsDb.Cells(x, NexantEnrollments.Status_ROSA) = "SCHEDULED" Then 'Or _
